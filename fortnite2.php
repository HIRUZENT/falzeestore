 ...
 <tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr>
      <td style="color: white; font-size: 20px; font-weight: bold;">Pilih Metode Pembayaran :
        ...
        <?php $qry = $conn->query("SELECT * FROM metode_pembayaran");
          ...
          <tr><td colspan="1" style="color: white; font-size: 20px; font-weight: bold; padding: 20px;">*Harga sudah termasuk PPN.<td style="color: white; padding: 20px; font-weight: bold;" colspan="2" rowspan="55">Top up FORTNITE Diamond hanya dalam hitungan detik! Cukup masukan Username FORTNITE Anda, pilih jumlah Diamond yang Anda inginkan, selesaikan pembayaran, dan Diamond akan secara langsung ditambahkan ke akun Mobile Legends Anda. Bayarlah menggunakan GoPay, ShopeePay, Dana, OVO, LinkAja</td><td></td></td>
        </tr>
...
</tr></td></table><img src="image/gambarfortnite.jpg" style="border-radius: 20px; margin-left: 1030px; width: 550px; margin-top: -720px; margin-bottom: 700px; background-color: white; padding: 5px;">
</form></div></body>
<body>
  <footer>
