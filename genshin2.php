...
<head>
    ...
    font-weight: bold;
    text-align: center;
    text-decoration: none;">Log Out</p>
             </a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</div>
  </head>
  <body>
    <nav>
      <ul class="item">
        <li><a href="falzeee.php">Home</li></a>
        <li><a href="#aboutus">About Us</li></a>
        <li><a href="bantuan.php">Bantuan</li></a>
      </ul>
    </nav>
  </header>
...
<form action="" method="post">
  	<table border="0" style="background-color: #000000; padding-top: 100px; padding-left: 100px; padding-right: 260px; justify-content: center; border-radius: 0px; padding-bottom: 130px;">
  		...
  		<input name="userid" style="text-align: center; border-bottom: 5px solid currentColor; font-weight: bolder; width: 300px; font-size: 18px; height: 50px; border-radius: 10px;" type="text" placeholder="USER ID" ></td>
  			<td style="color: white; font-size: 20px; font-weight: bold;">Masukkan SERVER ID :
  		<input name="serverid" style="text-align: center; border-bottom: 5px solid currentColor; font-size: 18px; width: 300px; height: 50px; border-radius: 10px; font-weight: bold;"  type="text" placeholder="ZONE ID" ><td style="padding-left: 600px;"></td>
      <tr>
  	<tr> 
 <tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr> <tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr>
      ...
      <div class="diamonds-options">
       <select id="nama" style="font-size: 18px;" onchange="hargadm()">
              ...
              <?php $qry = $conn->query("SELECT * FROM tabel_barang");
          while ($data = $qry->fetch_assoc()) {?>
            <option value="Rp. <?= $data['harga']; ?>.-"><?= $data['nama_barang']; ?></option>
          <?php }  ?>
        </select>
      ...
      <input name="email" style="text-align: center; border-bottom: 5px solid currentColor; font-size: 18px; width: 300px; height: 50px; border-radius: 10px; font-weight: bold;"  type="text" placeholder="E - mail" ><td style="padding-left: 200px;"></td>
      <tr><tr>
 <tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr>
      <td style="color: white; font-size: 20px; font-weight: bold;">Pilih Metode Pembayaran :
        ...
        <?php $qry = $conn->query("SELECT * FROM metode_pembayaran");
          ...
          <tr><td colspan="1" style="color: white; font-size: 20px; font-weight: bold; padding: 20px;">*Harga sudah termasuk PPN.<td style="color: white; padding: 20px; font-weight: bold;" colspan="2" rowspan="55">Top up GENSHIN IMPACT Diamond hanya dalam hitungan detik! Cukup masukan Username GENSHIN IMPACT Anda, pilih jumlah Diamond yang Anda inginkan, selesaikan pembayaran, dan Diamond akan secara langsung ditambahkan ke akun Mobile Legends Anda. Bayarlah menggunakan GoPay, ShopeePay, Dana, OVO, LinkAja</td><td></td></td>
        </tr>
...
</tr></td></table><img src="image/fotogenshin.jpg" style="border-radius: 20px; margin-left: 1030px; width: 550px; margin-top: -720px; margin-bottom: 700px; background-color: white; padding: 5px;">
</form></div></body>
<body>
  <footer>
